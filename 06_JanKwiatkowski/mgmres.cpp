...
//  Input:
//
//    double C, S, the cosine and sine of a Givens
//    rotation.
//
//    int K, indicates the location of the first vector entry.
//
//    double G[K+2], the vector to be modified.  
//
//  Output:
//
//    double G[K+2], the rotation has been applied to entries G(K) and G(K+1).
//
{
  double g1;
  double g2;
...
//
//    Thanks to Zhitao Li for pointing out that the L array should be
//    dimensioned NZ_NUM rather than IA[N]+1.
//
//  Licensing:
//
//    This code is distributed under the MIT license. 
...
//  Output:
//
//    double X[N]: an improved approximation.
//
{
  double av;
  double *c;
